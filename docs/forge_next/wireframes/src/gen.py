...
.progress .pb{height:8px;background:var(--raised);border-radius:6px;overflow:hidden}.progress .pb>i{display:block;height:100%;background:linear-gradient(90deg,var(--acc),color-mix(in srgb,var(--acc) 60%,#fff))}.progress .ps{font-size:12px;color:var(--mute)}
