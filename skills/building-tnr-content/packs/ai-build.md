<!-- RENDERED pack 'ai-build' from ai.md@dffeb23 + pipeline.md@bb57b3a via build_packs.py - edit the sources, never this file -->
# Pack: ai-build
...
<!-- pack-trace: pipeline.md @bb57b3a '1.4 Image upload (the builder resolves `@img` refs)' -->
...
<!-- pack-trace: pipeline.md @bb57b3a '2.4 AI enemy (profile)' -->
...
<!-- pack-trace: pipeline.md @bb57b3a 'Addendum: push-path rules learned in the field (Tower / Howling builds)' -->
