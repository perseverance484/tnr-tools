<!-- RENDERED pack 'jutsu-build' from jutsu.md@f9fa8cc + pipeline.md@f49e49f via build_packs.py - edit the sources, never this file -->
# Pack: jutsu-build
...
<!-- pack-trace: pipeline.md @f49e49f '2. Verified tRPC contracts' -->
...
<!-- pack-trace: pipeline.md @f49e49f '2.2 Jutsu' -->
### 2.2 Jutsu
