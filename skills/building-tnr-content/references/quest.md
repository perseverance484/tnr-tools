...
> Migrated from `23_GUIDE_quest.md` (Phase 3, 2026-08-26).

## Contents

  - [1. The objective graph](#1-the-objective-graph)
  - [2. Objective types](#2-objective-types)
  - [3. Battle objectives](#3-battle-objectives)
  - [4. Quest-level data model (complete)](#4-quest-level-data-model-complete)
  - [5. Quest tRPC contract](#5-quest-trpc-contract)
  - [6. Design](#6-design)
  - [7. Reference quests and worked examples](#7-reference-quests-and-worked-examples)
  - [8. QA checklist (before any quest push)](#8-qa-checklist-before-any-quest-push)
  - [Addendum (Jul 10 2026): new_quest mechanics, exclusivity findings, two write-validator rules](#addendum-jul-10-2026-newquest-mechanics-exclusivity-findings-two-write-validator-rules)
  - [Addendum (Jul 10 2026, source extraction): the quest engine from the repo (AUTHORITATIVE)](#addendum-jul-10-2026-source-extraction-the-quest-engine-from-the-repo-authoritative)
- [Appendix: source-verified engine semantics (merged from QUEST_ENGINE_ANALYSIS, 2026-07-18)](#appendix-source-verified-engine-semantics-merged-from-questengineanalysis-2026-07-18)
  - [2. Availability: the gating model (the answer to actions vs gates)](#2-availability-the-gating-model-the-answer-to-actions-vs-gates)
  - [6. reset_quest (exact semantics)](#6-resetquest-exact-semantics)
  - [7. The attackers ambush system (semantics differ from opponentAIs!)](#7-the-attackers-ambush-system-semantics-differ-from-opponentais)
  - [Unlock graph, reveal pacing, and profession quests (added 2026-07-27)](#unlock-graph-reveal-pacing-and-profession-quests-added-2026-07-27)
  - [Addendum: harvest Stage 1 facts (2026-08-01, from 52_HARVEST sweep)](#addendum-harvest-stage-1-facts-2026-08-01-from-52harvest-sweep)
