...
**Required numbers (gating; values are Brandon's call, but the fields are required)**
...
### 6.3 Reward philosophy (values are Brandon's call)
...
- [ ] Reward values, drop rates, and gates confirmed with Brandon; exact drop percentages not invented (6.3).
