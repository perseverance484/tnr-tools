...
## Listing icons — census addendum 2026-08-30
quest.image (listing icon) on all ten missions = engine default `..._default.webp`
...
2026-08-30 ruled: civilian brightness ceiling = the deputy (median value ~0.26, dark
share ~0.46). QC judges civilian gens against that ceiling; prompts still aim darker.
...
| Grain merchant | APPROVED scene_fsw_grain_merchant.webp | Protection p14-p16 |
