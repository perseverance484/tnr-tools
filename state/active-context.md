...
**In progress:** wave: Content: ARTWORK ONLY - prose passes (Old Ghost, Tenth Name) reassigned to coworker per dauntless 2026-08-30. Avatars 9/9 done. Art queue: 5 pins to generate (Repair, Dig, Watch, Deliver, Listen; Gather uses default collect_item pin per dauntless 2026-08-30; Chase pending dauntless ruling on twelfth) - 5 live per asset-manager view 2026-08-30 (Travel/Search/Pick/Fight/Climb, opaque navy house style); then backgrounds, scene portraits (Named-speak ruling pending). push/9 STATIC capture demoted to wiring-time (URLs). push/6 held on Terr wedge.
