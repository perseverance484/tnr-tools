...
**In progress:** wave: Content: ARTWORK ONLY - prose passes (Old Ghost, Tenth Name) reassigned to coworker per dauntless 2026-08-30. Avatars 9/9 done. Art queue: 12 map pins (34b, all asset_id null), backgrounds, scene portraits (Named-speak ruling pending). push/6 held on Terr wedge.
