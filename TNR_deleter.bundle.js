/* TNR Deleter v1.3 (hosted body; loaded via @require loader)
...
(function () {
  ...
  var GATES = {
    ...
    asset: { pre: function (id) { return gcall("gameAsset.get", { id: id }); }, del: "gameAsset.delete", key: "id" },
  ...
  panel.appendChild(el("div", { fontWeight: "bold", marginBottom: "4px" }, "TNR Deleter v1.3"));
  var sel = document.createElement("select");
  ["quest", "jutsu", "ai", "aiProfile", "item", "asset"].forEach(function (t) {
