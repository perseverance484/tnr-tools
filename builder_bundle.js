...
{const cb=(MANIFEST&&MANIFEST.capture&&MANIFEST.capture.before)||null;
 if(cb&&cb.length){try{window.__tnrCapBefore=await runCapture(cb,'before',null,t=>{$s.textContent=t})}catch(_e){}}}
